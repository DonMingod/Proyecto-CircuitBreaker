...
public class ExternalService {
	...
	@CircuitBreaker (name= "miCircuitBreaker" , fallbackMethod = "falla")
	...
	public String falla(Throwable t) {
	    System.out.println("ENTRO EL FALLBACKMETHOD" + t.getMessage());
	   return "Servicio externo no disponible. Motivo:";
	}
